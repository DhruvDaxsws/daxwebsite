    ...
    <div className="bg-background">
      ...
      <section className="py-16 md:py-24">
        <div className="container mx-auto px-4 max-w-4xl">
            <h2 className="text-3xl font-semibold mb-4">Purpose</h2>
            <p className="mb-4 text-muted-foreground"> This Privacy Policy applies to the information Dax Software Solutions, Inc. and its subsidiaries (collectively, “Dax Software Solutions,” “we,” “us,” or “our”) collects, including through our website or other online products and services (“Site”).</p>
            <p className="mb-4 text-muted-foreground">This Privacy Policy describes our personal information collection practices, such as the types of personal information we collect, how we may use that information, and for what purposes. By using this Site or purchasing our products or services, you consent to this Privacy Policy.</p>
            
            <h2 className="text-3xl font-semibold mb-4">Personal Information</h2>
            <h3 className="text-2xl font-semibold mb-4">Collection of Personal Information</h3>
            <p className="mb-4 text-muted-foreground">We may collect information that identifies, relates to, describes, references, is capable of being associated with, or reasonably could be linked, directly or indirectly, with a specific individual, consumer, or personal device, which may include your name, postal and/or email address, telephone number, financial information, and date of birth (“Personal Information”).</p>
            <p className="mb-4 text-muted-foreground">We may collect such information from you when you use the Site or provide us information in response to marketing efforts. We also receive Personal Information about you from our business partners and/or clients who share Personal Information with us to provide services or goods pursuant to a contract. Business partners, for purposes of this Privacy Policy, are defined as companies or organizations that Dax software solutions provides goods or services to, or that Dax software solutions does business with.</p>
            <p className="mb-4 text-muted-foreground">We may also collect Personal Information about you through your use of the Site. This information could include the type of device you are using, your IP address, the pages you visit while navigating the Site, and how long you visit certain pages. This information is collected for a variety of purposes, including enhancing or improving the Site or the services we offer to you.</p>
            
            <h3 className="text-2xl font-semibold mb-4">Use of Personal Information</h3>
            <p className="mb-4 text-muted-foreground">We may use Personal Information collected for one or more of the following business purposes:</p>
            ...
            <p className="mb-4 text-muted-foreground">If your affirmative consent is required for certain processing of any Personal Information subject to the GDPR, we will obtain your consent before so processing such information.</p>
            <p className="mb-4 text-muted-foreground">In any case, we can help to clarify the specific legal basis that applies to the processing, and in particular whether the provision of Personal Information subject to the GDPR is a statutory or contractual requirement, or a requirement necessary to enter into a contract.</p>

            <h3 className="text-2xl font-semibold mb-4">Place</h3>
            <p className="mb-4 text-muted-foreground">Personal Information is processed at Dax software solutions’ operating offices and in any other places where the parties involved in the processing are located. Depending on your location, data transfers may involve transferring the Personal Information to a country other than the one in which the data subject resides.</p>
            <p className="mb-4 text-muted-foreground">If broader protection standards are applicable, you are also entitled to learn about the legal basis of Data transfers to a country outside the European Union or to any international organization governed by public international law or set up by two or more countries, such as the UN, and about the security measures taken by the Owner to safeguard their Data.</p>
            <p className="mb-4 text-muted-foreground">If any such transfer takes place, you can find out more by checking the relevant sections of this document or inquire with the Owner using the information provided in the contact section.</p>

            <h3 className="text-2xl font-semibold mb-4">Information Transfer and Consent</h3>
            ...
            <p className="mb-4 text-muted-foreground">Your Personal Information may be transferred to and stored the United States, and may be processed and accessed by us, our affiliates and our unaffiliated service providers in the United States and in other jurisdictions where we or they operate. We comply with the EU-U.S. Privacy Shield Framework and Swiss-U.S. Privacy Shield Framework as set forth by the U.S. Department of Commerce regarding the collection, use, and retention of Personal Information transferred from the European Union and Switzerland to the United States.</p>
            <p className="mb-4 text-muted-foreground">Dax software solutions is responsible for the processing of personal data it receives under the Privacy Shield Framework and subsequently transfers to a third party acting as an agent on its behalf. Dax software solutions complies with the Privacy Shield Principles for all onward transfers of personal data from the EU and Switzerland, including the onward transfer liability provisions.</p>
            <p className="mb-4 text-muted-foreground">In compliance with the Privacy Shield Principles, Dax software solutions commits to resolve complaints about our collection or use of your Personal Information. EU and Swiss individuals with inquiries or complaints regarding our Privacy Shield policy should first contact Dax software solutions at: <a href="mailto:contact@daxsws.com" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">contact@daxsws.com</a>.</p>
            <p className="mb-4 text-muted-foreground">By using the Services, you consent to this transfer, processing, storage and access of your Personal Information in and/or outside of the jurisdiction in which you reside. Courts and other authorities in these jurisdictions may, in certain circumstances, be entitled to access your Personal Information. We will transfer your Personal Information subject to suitable safeguards, including in accordance with Privacy Shield Principles and/or standard contractual clauses where appropriate.</p>

            <h3 className="text-2xl font-semibold mb-4">Access to Information and Your Rights</h3>
            <p className="mb-4 text-muted-foreground">You have certain rights relating to your Personal Information, subject to local data protection laws. These rights may include:</p>
            <ul className="list-disc pl-5 mb-4 space-y-2 text-muted-foreground">
            ...
            <p className="mb-4 text-muted-foreground">To exercise these rights, please submit your specific request to exercise these rights by using the information in the “Dax Software Solutions Contact Information” section below.</p>
            
            <h3 className="text-2xl font-semibold mb-4">Timeframe for Responding to Requests</h3>
            <p className="mb-4 text-muted-foreground">Dax Software Solutions will respond to your request within thirty (30) days of receipt.</p>
            <p className="mb-4 text-muted-foreground">The period of response may be extended to forty-five (45) or sixty (60) days if more time is required. In that event, we will inform you of the reason and extension period in writing.</p>

            <h3 className="text-2xl font-semibold mb-4">Fee</h3>
            <p className="mb-4 text-muted-foreground">We do not charge a fee to process or respond to your verifiable consumer request unless it is excessive, repetitive, or manifestly unfounded.</p>
            
            <h3 className="text-2xl font-semibold mb-4">Your California Privacy Rights</h3>
            <p className="mb-4 text-muted-foreground">If you are a California resident, California law may provide you with additional rights regarding our use of your Personal Information. To learn more about your California privacy rights with respect to your Personal Information that we may collect via the Site, visit the Privacy Notice for California Residents.</p>
            
            <h3 className="text-2xl font-semibold mb-4">Links to Other Sites</h3>
            <p className="mb-4 text-muted-foreground">We may offer links to sites that are not operated by us. If you visit one of these linked sites, you should review their privacy and other policies. We are not responsible for the policies and practices of others.</p>
            
            <h3 className="text-2xl font-semibold mb-4">Changes to Privacy Policy</h3>
            <p className="mb-4 text-muted-foreground">From time to time, we may change this Privacy Policy with or without notice. Any changes will be effective <strong>immediately</strong> upon the posting of the revised Privacy Policy unless otherwise specified. Your continued use of our Site constitutes your acceptance of such changes.</p>
            
            <h2 className="text-3xl font-semibold mb-4">Dax Software Solutions Contact Information</h2>
            <p className="mb-4 text-muted-foreground">If you have any questions about the Privacy Policy or our privacy practices, please contact us at:</p>
